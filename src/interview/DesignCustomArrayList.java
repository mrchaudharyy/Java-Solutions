 ...
 */
public class DesignCustomArrayList {
     ...
     */
    public DesignCustomArrayList() {
        this(10);
    }

    /**
     * Constructor that allows an initial size to be passed to the array.
     * Pre condition: Parameter n must be larger than 0.
     * Post condition: The constructor initializes the arrayList data field with size n
     * and initializes the elementsInArray to 0.
     * @param n | The size of the arrayList array.
     */
    public DesignCustomArrayList(int n) {
        if (n <= 0) {
